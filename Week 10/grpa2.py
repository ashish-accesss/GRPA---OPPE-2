...
(1)_init _: accept a list words as argument and assign it to the corresponding attribute
...
(4) words_of_length: accept a positive integer length as argument and return a list of all the words in the list words that have a length equal to
length
...
(1) For those methods where you are expected to return a list of words, make sure that the words in the returned list appear in the order in which
they are present in the attribute words.

(2) Each test case corresponds to one or more method calls. We will use S to denote the name of the object.

(3) You do not have to accept input from the user or print output to the console. You just have to define the class based on the specifications given
in the question.'''
